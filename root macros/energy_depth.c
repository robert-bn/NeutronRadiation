// Reads an output .root file from g4beamline, and enables one to produce many graphs from the data.
// Should be fairly easily adaptable to different setups in g4beamline.
